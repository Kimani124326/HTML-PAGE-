  ...
  $sql2 = "INSERT INTO `2fa`(`OTP`) VALUES (md5('$otp'))";
   ...
   mysqli_query($conn, $sql2);
            ...
            //Compose and Send Email
                ...
                $mail->SMTPAuth = 'true';
                $mail->Username = 'jmkimani7@gmail.com'; 
                $mail->Password = 'eglrztpzckkvcscx'; 
                $mail->SMTPSecure = 'ssl';
                $mail->Port = 465;

                $mail->setFrom('jmkimani7@gmail.com'); 
                $mail->addAddress($email); 
                $mail->isHTML(true);
                $mail->Subject = 'Tech Site Platform - OTP Password for Login';
                $mail->Body = 'Dear Client, '. $fname . ',
  ...
  $sql2 = "INSERT INTO `2fa`(`OTP`) VALUES (md5('$otp'))";
   ...
   mysqli_query($conn, $sql2);
            ...
            //Compose and Send Email
                ...
                $mail->addAddress($email); 
                $mail->isHTML(true);
                $mail->Subject = 'Tech Site Platform - OTP Password for Reset Password';
                $mail->Body = 'Dear Client, '. $fname . ',

                Below is your OTP for resetting your password attempt at ' .  date("Y-m-d h:i:s") . ', it expires in 5 minutes:
                <br>
                <br>
                <p><b>' . $otp . '</b></p>
                <br>
                <br>
                If you did not request this reset my password attempt, kindly ignore this email.
                <br>
                <br>
                Kind Regards,
                Tech Site Platform Team.';
